...
import AjusteCuentas from './pages/AjusteCuentas'
    ...
    <div className="app">
      ...
      <main className={user ? 'main-content' : 'main-content-login'}>
        <Routes>
          ...
          <Route path="/porrolimpiadas" element={<RequireMember section="porrolimpiadas"><Porrolimpiadas /></RequireMember>} />
          <Route path="/premios-porro" element={<RequireMember><PremiosPorro /></RequireMember>} />
          <Route path="/fantasy" element={<RequireMember section="fantasy"><Fantasy /></RequireMember>} />
          <Route path="/galeria" element={<RequireMember><Galeria /></RequireMember>} />
          <Route path="/galeria/:tripSlug" element={<RequireMember><Galeria /></RequireMember>} />
