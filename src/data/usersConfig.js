export const USERS = [
  ...
  { id: "sergio",       nombre: "Sergio",        role: "admin", color: "linear-gradient(135deg, #1a2e80 0%, #4878e8 45%, #2a44b8 100%)"  }, // Cobalto
  ...
  { id: "abel",         nombre: "Abel",          role: "admin", color: "linear-gradient(135deg, #416100 0%, #a0d010 45%, #5a8000 100%)"  }, // Dorado Verdoso
