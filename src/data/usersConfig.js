...
export const USERS = [
  { id: "adri",         nombre: "Adri",         cumer: true,  color: "linear-gradient(135deg, #9a6800 0%, #ffd700 45%, #c88e00 100%)"  },
  { id: "jose",         nombre: "Jose",          cumer: true,  color: "linear-gradient(135deg, #a02030 0%, #ff7080 45%, #c83848 100%)"  },
  { id: "sergio",       nombre: "Sergio",        role: "admin", cumer: true,  color: "linear-gradient(135deg, #1a2e80 0%, #4878e8 45%, #2a44b8 100%)"  },
  ...
  { id: "jorge",        nombre: "Jorge",         cumer: true,  color: "linear-gradient(135deg, #4a2800 0%, #a06010 45%, #6e3c00 100%)"  },
  { id: "juanfran",     nombre: "Juanfran",      cumer: true,  color: "linear-gradient(135deg, #100850 0%, #4028c0 45%, #201080 100%)"  },
  { id: "abel",         nombre: "Abel",          role: "admin", cumer: true,  color: "linear-gradient(135deg, #416100 0%, #a0d010 45%, #5a8000 100%)"  },
...
export const CUMERS = USERS.filter(u => u.cumer)
export const CUMERS_IDS = CUMERS.map(u => u.id)
